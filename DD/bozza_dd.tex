...
\begin{center}
 ...
 \captionof{figure}{Mock up educator's battles view}
\label{fig:mk1}
\end{center}

\begin{center}
  \includegraphics[width=\linewidth]{mok2.png}
 \captionof{figure}{Mock up team creation}
\label{fig:mk2}
\end{center}

\begin{center}
  \includegraphics[width=\linewidth]{mok3.png}
 \captionof{figure}{Mock up battle creation}
\label{fig:mk3}
\end{center}

\begin{center}
  \includegraphics[width=\linewidth]{mok4.png}
 \captionof{figure}{Mock up submission evaluation}
\label{fig:mk4}
\end{center}
